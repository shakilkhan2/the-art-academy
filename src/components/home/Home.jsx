...
const Home = () => {
    ...
    return (
        <div>
           ...
           <Slider/>
           <h1 className="text-4xl font-bold text-center text-amber-600 mt-8">Popular Classes</h1>
           <PopularClasses/>
           <h1 className="text-4xl font-bold text-center text-amber-600 mt-4">Popular Instructors</h1>
           <PopularInstructor/>
           <div>
           <h1 className="text-4xl font-bold text-center text-amber-600 my-4">Common Questions</h1>
  ...
  <div className="collapse collapse-arrow join-item border border-amber-300">
    ...
    <div className="collapse-content"> 
      <p>Yes, all of our classes are available online. We understand the importance of flexibility and accessibility, which is why we have designed our courses to be accessible remotely. Whether you're located in a different city or even a different country, you can still enroll in our courses and participate in virtual classrooms. Our online platform provides an interactive learning experience, allowing you to engage with instructors and fellow students, access course materials, and submit assignments online. So, you can conveniently join our classes from the comfort of your own home or any location with an internet connection. Start your learning journey with us today!</p>
    </div>
  </div>
</div>
           </div>
